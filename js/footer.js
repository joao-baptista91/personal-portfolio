  ...
  <footer id="contact" class="site-footer">
    <div class="container">
      <h2 class="section-title">
        ...
        <span data-i18n="footer.title">Contactos</span>
      </h2>
    ...
    <div class="container footer-grid">
      ...
      <div class="footer-contact">
        ...
        <div class="social-links">
          ...
          <a class="social-icon" href="https://www.outsystems.com/profile/sdkthxzsus/" target="_blank" rel="noopener" aria-label="Perfil OutSystems" title="Perfil OutSystems" data-i18n-title="footer.outsystemsLabel">
            <svg viewBox="22.5 0 400 400" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path fill="currentColor" d="M422.5,200c0,110.4-89.5,200-200,200c-110.4,0-200-89.5-200-200c0-110.4,89.5-200,200-200C332.9,0,422.5,89.6,422.5,200z M149.1,200c0,40.5,32.9,73.4,73.4,73.4s73.4-32.9,73.4-73.4s-32.9-73.4-73.4-73.4S149.1,159.5,149.1,200z"/>
            </svg>
          </a>
