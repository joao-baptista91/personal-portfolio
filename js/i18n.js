...
const TRANSLATIONS = {
  pt: {
    ...
    "continuedu.subtitle": "Cursos e sessões da comunidade OutSystems que frequentei para continuar a expandir competências técnicas.",
  ...
  en: {
    ...
    "continuedu.subtitle": "Courses and OutSystems community sessions I attended to keep expanding my technical skillset.",
