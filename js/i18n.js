...
const TRANSLATIONS = {
  pt: {
    ...
    "projects.subtitle": "Cada aplicação parte de um problema real, identificado no trabalho ou no dia a dia, e procura resolvê-lo de forma simples e eficiente. Em cada projeto é possível conhecer o problema de origem, a solução desenvolvida e o que aprendi durante o desenvolvimento.",
  ...
  en: {
    ...
    "projects.subtitle": "Each application starts from a real problem, found at work or in everyday life, and aims to solve it in a simple and efficient way. In each project you can see the original problem, the solution developed and what I learned along the way.",
