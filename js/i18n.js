...
const TRANSLATIONS = {
  pt: {
    ...
    "hero.text": "Desenvolvo e dou suporte a aplicações web, sobretudo na plataforma OutSystems, incluindo projetos que integram Inteligência Artificial de forma aplicada. Trago também uma base em Engenharia da Energia e do Ambiente, que aplico na forma como penso cada solução: com foco em eficiência e melhoria contínua.",
  ...
  en: {
    ...
    "hero.text": "I develop and support web applications, mainly on the OutSystems platform, including projects with applied Artificial Intelligence. I also bring a background in Energy and Environmental Engineering, which shapes how I approach each solution: with a focus on efficiency and continuous improvement.",
